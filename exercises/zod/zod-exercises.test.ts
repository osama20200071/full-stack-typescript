...
describe('Basic Zod (Exercises)', () => {
  ...
  const primeNumberSchema = z.number().refine(isPrime, { message: "Quantity must be prime!'" });
   ...
   *
   */
  const dateStringSchema = z.string().transform((value) => {
  ...
  describe.todo('Challenge 10: Full Form Validator', () => {
